    ...
    <div className='MainComponents-Container'>
        <nav className='Nav-div'>
            ...
            <ul className='ul-items2'>
                ...
                <li><a href='Assets/Resume.pdf' for="Resume" download="Pokesh-kumar_Resume"><button id='Resume' className='Nav-Button'>Resume<FontAwesomeIcon className='Dicons' icon={faDownload} /></button></a></li>
            </ul>
        </nav>
