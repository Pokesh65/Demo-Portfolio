        ...
        <div className='conatact-container'>
          ...
          <div className="contact-icons">
            <ul>
              ...
              <li><a href="whatsapp://send?phone=916383532388&text=Hello%20Pokesh%20Kumar"><WhatsAppIcon  className='Cnt-Icons' sx={{fontSize:"70px"}}/></a><div className='icons-title'>Whatsapp</div></li>
            </ul>
          </div>
        </div>
    </div>
